...
def load_model(model_name, select_notebook_file):
    ...
    tokenizer = pickle.load(open(f"{select_notebook_file}/count-vectorizer.pkl", "rb"))
    model = pickle.load(open(model_name, "rb"))
    return tokenizer, model


def make_pred(tweet, model_name, select_notebook_file):
    total_model_path = f"{select_notebook_file}/{model_name}.pkl"
...
def load_gnn_model(tokenizer_path, pmi_model_path):
    tokenizer = pickle.load(open("gnn_model/gnn_tokenizer.pkl", "rb"))
    pmi_model_graph = pickle.load(open("gnn_model/cached_pmi_model.p", "rb"))
    embedding_size = 150
